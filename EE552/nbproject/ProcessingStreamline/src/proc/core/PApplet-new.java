...
/*
  (c)2018 Dov Kruger and StevensCAD team
  Based on Processing Library
  @see license.txt
*/
 ...
 */
public class GraphicsWin extends PSketch implements PConstants {
...
//  static public final String ARGS_SPAN_DISPLAYS = "--span";
  ...
  */
  ...
  final static public String sketchRenderer() {
    return renderer;
  }
  ...
  final static public String sketchOutputPath() {
    return outputPath;
  }
